            ...
            <?php foreach ($sectors as $sector) { ?>
                <div class="col-span-12 md:col-span-4">
                    <a href="<?php echo $sector['url']; ?>" title="<?php echo $sector['title']; ?>" aria-label="<?php echo $sector['title']; ?>" tabindex="0" class="relative overflow-hidden block rounded-2xl group">
                        <img src="<?php echo $sector['img']; ?>" alt="<?php echo $sector['title']; ?>" class="w-full h-48 brightness-75 object-cover object-center group-hover:brightness-100 group-hover:scale-110 transition-all">
